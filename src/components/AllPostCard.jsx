                            ...
                            <div className="post-into p-4 flex flex-col gap-4">
                                <div className="post-author flex justify-start items-center gap-2">
                                    <Link href={`/author/${authorSlug}`} className="w-[30px] h-[30px] relative rounded-full overflow-hidden">
                                        <Image src={AuthorAvatar} fill priority className="object-cover" alt={post.author.name}/>
                                    </Link>
                                    <Link href={`/author/${authorSlug}`}>{post.author.name}</Link>
                                    <p>•</p>
                                    <p>{new Date(post.createdAt).toLocaleDateString(undefined, {
                                        year: "numeric",
                                        month: "short",
                                        day: "numeric",
                                        })}
                                ...
                                <Link href={`/post/${postUrl}`} className="line-clamp-2 block text-base font-semibold text-neutral-900 dark:text-neutral-100">{post.title}</Link>
